...
- workplaceIntegrity.ts: export type DeleteWorkplaceCascadeResult = |; export async function resolveActiveWorkplaceId(): Promise<string | null>; export async function countLinked(workplaceId: string): Promise<number>; export async function canAddWorkplace(): Promise<boolean>; export async ...
...
- 0010: 기록 입력/수정 페이지 `/record/new`, `/record/:id/edit` (files: src/pages/RecordNew.tsx, src/pages/RecordEdit.tsx)
